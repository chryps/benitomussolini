...
exports.run = (client, message, params) => {
  ...
  .addField("**Yapımcı**", " **Ahmet Ali Bora** ")
  .setFooter('**--------------------------**')
  if (!params[0]) {
